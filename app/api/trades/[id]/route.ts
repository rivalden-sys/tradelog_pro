...
const UpdateSchema = z.object({
  ...
  risk_type:       z.enum(['percent', 'usdt']).optional(),
  risk_value:      z.number().positive().optional(),
  entry_price:     z.number().positive().optional(),
  stop_price:      z.number().positive().optional(),
  take_price:      z.number().positive().optional(),
  planned_rr:      z.number().positive().optional(),
  planned_profit_usd: z.number().optional(),
  planned_profit_pct: z.number().optional(),
  actual_result:      z.enum(['Тейк', 'Стоп', 'БУ']).optional(),
  actual_profit_usd:  z.number().optional(),
  actual_profit_pct:  z.number().optional(),
