    ...
    <main style={{ background: '#080808', minHeight: '100vh', color: '#fff', fontFamily: FONT, overflowX: 'hidden' }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', padding: '120px 24px 80px' }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: 800, position: 'relative', zIndex: 1 }}>
          <div style={{
            ...
            <span style={{ fontSize: 13, color: '#30d158', fontWeight: 600 }}>AI-powered trading journal</span>
          </div>
      ...
      <section style={{ padding: '0 48px 120px', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{ fontSize: 13, color: '#30d158', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16 }}>Features</div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
          {[
            ...
            <div key={f.title} style={{
              ...
              <div style={{ width: 48, height: 48, borderRadius: 14, marginBottom: 20, background: `${f.color}18`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>{f.icon}</div>
      ...
      <section style={{ padding: '0 48px 120px', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{ fontSize: 13, color: '#0a84ff', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16 }}>How it works</div>
      ...
      <section style={{ padding: '0 48px 120px', maxWidth: 900, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{ fontSize: 13, color: '#ff9f0a', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 16 }}>Pricing</div>
          <h2 style={{ fontSize: 48, fontWeight: 900, letterSpacing: '-0.04em',
            background: 'linear-gradient(180deg, #fff 0%, rgba(255,255,255,0.6) 100%)',
            WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            Start for free
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
          <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, padding: '40px 36px' }}>
            ...
            <Link href="/register" style={{ display: 'block', textAlign: 'center', marginTop: 32, padding: '14px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.12)', color: '#fff', textDecoration: 'none', fontSize: 15, fontWeight: 600 }}>Get started →</Link>
          </div>

          <div style={{ background: 'rgba(48,209,88,0.06)', border: '1px solid rgba(48,209,88,0.25)', borderRadius: 24, padding: '40px 36px', position: 'relative', overflow: 'hidden' }}>
            <div style={{ position: 'absolute', top: 20, right: 20, background: '#30d158', color: '#000', fontSize: 11, fontWeight: 800, padding: '4px 12px', borderRadius: 100 }}>RECOMMENDED</div>
            ...
            <Link href="/register" style={{ display: 'block', textAlign: 'center', marginTop: 32, padding: '14px', borderRadius: 12, background: '#30d158', color: '#000', textDecoration: 'none', fontSize: 15, fontWeight: 800, boxShadow: '0 0 30px rgba(48,209,88,0.25)' }}>Start Pro →</Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '0 48px 120px', maxWidth: 800, margin: '0 auto', textAlign: 'center' }}>
        <div style={{ background: 'rgba(48,209,88,0.06)', border: '1px solid rgba(48,209,88,0.15)', borderRadius: 28, padding: '64px 48px', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(48,209,88,0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
          ...
          <Link href="/register" style={{ padding: '16px 44px', borderRadius: 14, background: '#30d158', color: '#000', textDecoration: 'none', fontSize: 17, fontWeight: 800, boxShadow: '0 0 50px rgba(48,209,88,0.3)', position: 'relative' }}>
            Start for free →
          </Link>
        </div>
      </section>
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '32px 48px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', maxWidth: 1200, margin: '0 auto' }}>
        <div style={{ fontSize: 15, fontWeight: 800, letterSpacing: '-0.03em' }}>
          TradeLog <span style={{ color: '#30d158' }}>Pro</span>
        </div>
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.25)' }}>by dnproduction · 2026</div>
      </footer>
