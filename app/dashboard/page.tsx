...
export default function DashboardPage() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', fontFamily: FONT, color: t.sub }}>
      Загрузка...
    </div>
  )
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 16, marginBottom: 16 }}>
        ...
        <div style={card(t)}>
          ...
          {balance.length > 1 ? (
            ...
            <div style={{ height: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', color: t.sub, fontSize: 13 }}>
              Недостаточно данных
            </div>
          )}
        </div>
